...
public class TOD : MonoBehaviour {
    ...
    void OnGUI()
    {
        ...
        Hour = slider * 24.0f;
        Tod = slider2 * 24.0f;
        sun.transform.localEulerAngles = new Vector3((slider * 360.0f) - 90, 0, 0);
        ...
        {
            Water.GetComponent<Renderer>().material.SetColor("_horizonColor", Color.Lerp(WaterNight, WaterDay, slider2*2.0f - 0.2f));
        }
